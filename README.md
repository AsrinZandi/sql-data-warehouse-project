...
Designed a modern data warehouse using:
Staging layer
...
Built ETL pipelines to extract and load raw data into staging tables for further processing.

3. Data Cleaning & Transformation (Transform)
Cleaned messy data using SQL:
Removed duplicates
Handled NULL values
...
Validated and corrected data quality issues.
